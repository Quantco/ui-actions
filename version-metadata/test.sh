...
export GITHUB_EVENT_NAME="pull_request" # can be "pull_request", "push", or "merge_group"
...
# export INPUT_VERSION_EXTRACTION_OVERRIDE="regex:version = \"(.*)\"" # maps to `version-extraction-override` input in action.yml
